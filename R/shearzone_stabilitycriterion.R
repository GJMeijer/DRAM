...
#' @param Erep root elasto-plastic stiffness
...
shearzone_stabilitycriterion <- function(h,us, c,phi,sign,taui, Cr,Ar,Lr,phir,alpha0,beta0, try,tru,Ere,Erep,kappat=NULL,fb0=NULL) {
  ...
  tr_unbroken <- tensilestress_unbroken(Cr,Ar,Lr, try,Ere,Erep, taui,h,cosbeta,cos(beta0))$tr
  #breakage parameter
